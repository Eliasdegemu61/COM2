    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="mb-4 flex justify-between items-start">
          <div>
            <div className="flex items-center gap-3 mb-3">
              <img src="https://sosovalue.com/img/192x192.png" alt="SoSoValue" className="w-16 h-16 rounded-lg" />
              <h1 className="text-2xl sm:text-5xl lg:text-6xl font-bold text-foreground tracking-tight">Community Analytics 2026</h1>
            </div>
            {/* Insights from {communities.find((c) => c.value === community)?.label} */}
          </div>
          <button
            onClick={() => setIsDarkMode(!isDarkMode)}
            className="p-3 rounded-lg hover:bg-secondary transition-all duration-200 text-foreground shadow-sm hover:shadow-md"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 items-start sm:items-center">
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-sans text-xs sm:text-sm font-medium whitespace-nowrap transition-all duration-200 flex items-center gap-2 ${
                  platform === "telegram"
                    ? "bg-accent text-accent-foreground shadow-md"
                    : "bg-card border border-border text-foreground hover:border-accent"
                }`}
              >
                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-sYfsJPX7XBh3ycRiYty9WabgYEf4VO.png" alt="Telegram" className="w-4 h-4" />
                Telegram
              </button>
              <button
              ...
              >
                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-DYo4M8TtPJeeGKnoRe7b1EM4uI4BHB.png" alt="Discord" className="w-4 h-4" />
                Discord
              </button>
            </div>

            {platform === "telegram" && (
              <div className="inline-flex bg-card border border-border rounded-lg p-1 w-fit gap-1">
                  ...
                  <button
                    ...
                    className={`px-2 py-1 rounded-md transition-all duration-200 flex items-center justify-center ${
                      community === comm.value
                        ? isDarkMode ? "shadow-md shadow-accent/20" : "shadow-lg shadow-accent/50"
                        : "hover:opacity-80"
                    }`}
                  >
                    {comm.value === "SOSOVALUE" && (
                      <img
                        src={isDarkMode ? "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-xVVoPY4Pe9pg45E03QUgO1ewIY8gAF.png" : "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-uOCLNQHQto8RQRboGT1er3P8uAZ0x2.png"}
                        alt="SoSoValue"
                    ...
                    {comm.value === "SODEX" && (
                      <img
                        src={isDarkMode ? "https://sodex.com/_next/image?url=%2Flogo%2Flogo.webp&w=128&q=75" : "https://testnet.sodex.com/assets/SoDEX-Dh5Mk-Pl.svg"}
                        alt="SoDEX"
                        className="h-4 w-auto object-contain"
                        onError={(e) => console.log("[v0] SoDEX image failed to load:", e)}
                      />
                    )}
                  </button>
                ))}
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-2 items-start sm:items-center w-full">
            <div className="flex gap-2 items-center">
              <div className="relative">
                <button
                  onClick={() => setShowCalendar(!showCalendar)}
                  className="bg-card border border-border rounded-lg px-4 py-2 text-foreground font-sans flex items-center gap-2 hover:border-accent hover:shadow-md transition-all duration-200 text-xs sm:text-sm font-medium"
                >
                ...
                {showCalendar && (
                  <div className="absolute top-full mt-3 left-0 sm:right-0 sm:left-auto bg-card border border-border rounded-lg shadow-lg p-5 z-50 w-80">
